...
class BSUVNet:
    ...
    model_path = "./trained_models/model_epoch149.mdl"
    ...
    empty_bg_path = "examples/spinneys-cut.jpg"# outside spinneys-cut bg_sample bg_PETS2006 bg_office bg_PETS2006 Candela_m1_10_empty_BG.jpg" # Path of the empty background. Only used when empty_bg="manual"
