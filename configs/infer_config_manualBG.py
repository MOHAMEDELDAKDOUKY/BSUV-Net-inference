...
class BSUVNet:
    ...
    model_path = "./trained_models/model_epoch15.mdl"
    ...
    empty_bg_path = "examples/bg_8.jpg"# spinneys-cut bg_sample bg_PETS2006 bg_office bg_PETS2006 Candela_m1_10_empty_BG.jpg" # Path of the empty background. Only used when empty_bg="manual"
