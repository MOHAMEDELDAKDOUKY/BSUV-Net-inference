...
class BSUVNet:
    ...
    model_path = "./trained_models/model_best_2stream_att.mdl"
    ...
    empty_bg_path = "examples/bg_sample.jpg"#bg_sample bg_PETS2006 Candela_m1_10_empty_BG.jpg" # Path of the empty background. Only used when empty_bg="manual"
