...
class unet_vgg16(nn.Module):
    ...
    def forward(self, inp):
        ...
        # d5 = self.enc5(d4)
        print(inp.shape)
        empty_bg_out, empty_bg_feats = self.empty_bg_enc(inp[0])
        #recent_bg_feats = self.recent_bg_bg_enc(inp[1])
        curr_fr_out, curr_fr_feats = self.curr_fr_enc(inp[2])
